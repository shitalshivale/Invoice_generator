...
def generate_invoice(df):
    ...
    for customer_id, group in grouped_df:
        ...
        generated_pdf_file=generate_pdf(invoice_data)
        invoice_files_for_download.append(generated_pdf_file)
        Invoice_Number +=1
    return invoice_files_for_download
